...
In the [Tools](https://github.com/ipleiria-robotics/indoor_positioning_uwb/tree/main/tools) folder we have an excel file with the calibrations that we made during our process. We recommend to use it in case of calibration is needed.
